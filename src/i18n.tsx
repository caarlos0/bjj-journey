...
const dict = {
  'en-US': {
    ...
    'profile.currentWeight': 'Current weight ({unit})',
    'profile.currentWeightHint': "Changes are added to today's timeline.",
    'profile.weightUnit': 'Weight unit',
    'profile.uniform': 'Uniforms',
  ...
  'pt-BR': {
    ...
    'profile.currentWeight': 'Peso atual ({unit})',
    'profile.currentWeightHint': 'As alterações entram na linha do tempo de hoje.',
    'profile.weightUnit': 'Unidade de peso',
    'profile.uniform': 'Uniformes',
